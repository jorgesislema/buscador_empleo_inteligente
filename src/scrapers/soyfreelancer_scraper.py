...
class SoyFreelancerScraper(BaseScraper):
    ...
    def fetch_jobs(self, search_params: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        while current_page <= MAX_PAGES_TO_SCRAPE_SOYFREELANCER:
            ...
            project_cards = soup.select('div.project-item, div.project-card-wrapper')
            ...
            for card in project_cards:
                ...
                title_link_element = card.select_one('h2.project-title a, a.project-link')
                ...
                if oferta['url']:
                    ...
                    if detail_soup:
                        desc_container = detail_soup.select_one('div.project-description-full, section#project-details')
            ...
            next_page_link_element = soup.select_one('a.pagination-next, li.next a')
